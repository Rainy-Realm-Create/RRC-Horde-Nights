...
tellraw @s {"text":" "}
tellraw @s [{"text":"Horde Nights","bold":true,"underlined":true,"color":"#80FF00"},{"text":" ","bold":true,"underlined":false,"color":"dark_green"},{"text":"v1.3.4s","bold":true,"underlined":true,"color":"dark_purple"},{"text":" ","bold":true,"underlined":false},{"text":"Config","bold":true,"underlined":true,"color":"yellow"},{"text":" ","bold":true,"underlined":false},{"text":"For 1.21-1.21.4","bold":true,"underlined":true,"color":"dark_purple"}]
tellraw @s {"text":" "}
