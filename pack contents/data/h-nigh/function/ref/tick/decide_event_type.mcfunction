...
execute unless score #used h-nigh.ritual matches 2 if score #natural_bunk h-nigh.config matches 0 run scoreboard players set #bunk_events h-nigh.lunar_event_decide 0
...
execute if score #used h-nigh.ritual matches 2 run scoreboard players set #bunk_events h-nigh.lunar_event_decide 3
...
# Super Moon Math
execute unless score #bunk_events h-nigh.lunar_event_decide matches 2..3 store result score #super_moon h-nigh.lunar_event_decide run function h-nigh:ref/tick/decide_event_type/super_moon
...
execute unless score #bunk_events h-nigh.lunar_event_decide matches 2..3 run scoreboard players operation #weight h-nigh.lunar_event_decide += #super_moon h-nigh.lunar_event_decide
...
#execute unless score #festive_moon h-nigh.config matches 1 if score #bunk_events h-nigh.lunar_event_decide matches 1..3 run scoreboard players set #bunk_festive_moon h-nigh.lunar_event_decide 100
...
#execute if score #bunk_events h-nigh.lunar_event_decide matches 1..3 run scoreboard players operation #weight h-nigh.lunar_event_decide += #festive_moon h-nigh.lunar_event_decide
...
execute if score #bunk_events h-nigh.lunar_event_decide matches 2..3 if score #weight h-nigh.lunar_event_decide matches 0 run return 2
...
execute if score #bunk_events h-nigh.lunar_event_decide matches 1..3 store result score #bunk_blood_moon h-nigh.lunar_event_decide run function h-nigh:ref/tick/decide_event_type/blood_moon
...
execute if score #bunk_events h-nigh.lunar_event_decide matches 1..3 run scoreboard players operation #weight h-nigh.lunar_event_decide += #bunk_blood_moon h-nigh.lunar_event_decide
