...
execute as @e[type=minecraft:bogged,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/bogged/blood"}
...
#======Skeleton=====#
execute as @e[type=minecraft:skeleton,tag=h-nigh.mob,tag=!h-nigh.not_skeleton_horse,sort=random,scores={h-nigh.y=60..}] run function h-nigh:ref/tick/events/blood_moon/horde_mobs/skeletons/skeleton_horse
#==Generic==#
execute as @e[type=minecraft:skeleton,tag=h-nigh.mob] run effect give @s minecraft:infested infinite 1 true
execute as @e[type=minecraft:skeleton,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/skeleton/blood"}
...
#=======Stray=======#
execute as @e[type=minecraft:stray,tag=h-nigh.mob,tag=!h-nigh.not_stray_horse,sort=random,scores={h-nigh.y=60..}] run function h-nigh:ref/tick/events/blood_moon/horde_mobs/skeletons/stray_horse
#==Generic==#
execute as @e[type=minecraft:stray,tag=h-nigh.mob] run effect give @s minecraft:infested infinite 2 true
execute as @e[type=minecraft:stray,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/stray/blood"}
