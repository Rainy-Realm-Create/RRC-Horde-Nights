...
#==Badlands Creeper==#
execute as @e[type=creeperoverhaul:badlands_creeper,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/badlands_creeper/super"}


#===Bamboo Creeper===#
execute as @e[type=creeperoverhaul:bamboo_creeper,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/bamboo_creeper/super"}
#====Easy===#
...
#====Beach Creeper===#
execute as @e[type=creeperoverhaul:beach_creeper,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/beach_creeper/super"}


#====Cave Creeper====#
execute as @e[type=creeperoverhaul:cave_creeper,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/cave_creeper/super"}


#==Dark Oak Creeper==#
execute as @e[type=creeperoverhaul:dark_oak_creeper,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/dark_oak_creeper/super"}


#===Desert Creeper===#
execute as @e[type=creeperoverhaul:desert_creeper,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/desert_creeper/super"}


#==Dripstone Creeper=#
execute as @e[type=creeperoverhaul:dripstone_creeper,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/dripstone_creeper/super"}


#====Hills Creeper===#
execute as @e[type=creeperoverhaul:hills_creeper,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/hills_creeper/super"}


#===Jungle Creeper===#
execute as @e[type=creeperoverhaul:jungle_creeper,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/jungle_creeper/super"}


#==Savannah Creeper==#
execute as @e[type=creeperoverhaul:savannah_creeper,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/savannah_creeper/super"}
#====Easy===#
...
#====Snowy Creeper===#
execute as @e[type=creeperoverhaul:snowy_creeper,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/snowy_creeper/super"}
#====Easy===#
...
#===Spruce Creeper===#
execute as @e[type=creeperoverhaul:spruce_creeper,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/spruce_creeper/super"}


#====Swamp Creeper===#
execute as @e[type=creeperoverhaul:swamp_creeper,tag=h-nigh.mob] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/swamp_creeper/super"}