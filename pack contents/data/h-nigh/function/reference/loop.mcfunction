...
execute if score #night_active h-nigh.status matches 0 run function h-nigh:reference/tick/event_running/calculate_interval/night with storage rrc_data:h-nigh interval
