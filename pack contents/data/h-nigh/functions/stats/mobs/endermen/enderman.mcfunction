...
execute unless score @s h-nigh.cowards matches 1..2 run scoreboard players add @s h-nigh.enderman_slay_stat 1
execute unless score @s h-nigh.cowards matches 1..2 run scoreboard players set @s h-nigh.time-slay 0
advancement revoke @s only h-nigh:stats/mobs/endermen/enderman