...
#=====Zombies====#
execute unless score #day h-nigh.day = #interval h-nigh.config as @e[type=#h-nigh:zombies,tag=!h-nigh.ignore] run tag @s add h-nigh.ignore

#====Skeletons===#
execute unless score #day h-nigh.day = #interval h-nigh.config as @e[type=#h-nigh:skeletons,tag=!h-nigh.ignore] run tag @s add h-nigh.ignore

#=====Phantom====#
execute unless score #day h-nigh.day = #interval h-nigh.config as @e[type=minecraft:phantom,tag=!h-nigh.ignore] run tag @s add h-nigh.ignore

#=====Spider=====#
execute unless score #day h-nigh.day = #interval h-nigh.config as @e[type=minecraft:spider,tag=!h-nigh.ignore] run tag @s add h-nigh.ignore

#=====Creeper====#
execute unless score #day h-nigh.day = #interval h-nigh.config as @e[type=minecraft:creeper,tag=!h-nigh.ignore] run tag @s add h-nigh.ignore
